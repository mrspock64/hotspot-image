...
- **Idé att fundera vidare på:** återanvänd själva ambienta vattenfallet (`modules/rxmonitor/panel.js`) på ett annat ställe än den egna modul-kortet — t.ex. i topbaren/toppnivån (jfr `docs/dashboard-redesign-concept.html`), triggat av nodens RX/TX-status snarare än av om en inspelning råkar pågå. Skulle ge samma "liv i dashboarden"-känsla överallt, inte bara i RX Monitor-modulen. Inte påbörjat — bara en tanke från 2026-09-13 värd att utforska.
