...
<div class="mx-section">Backup</div>
<p><a href="download.php"><button type="button" class="mx-btn">Download backup</button></a></p>
...
<div class="mx-section">Restore from file</div>
<?php
$errors = [];
$log = [];
