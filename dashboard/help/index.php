...
<div class="mx-card">
  ...
  <table class="mx-table">
    ...
    <tr><td><b>Bluetooth</b></td><td>On/off switch for the BLE service the <a href="https://svxlink-hotspot.app" target="_blank" rel="noopener">companion app</a> connects to. No pairing/password is required to connect while it's on by default, so turn it on only while actively using the app nearby -- it always starts back up OFF after a reboot, whatever state you leave it in here. To require the phone to pair first instead, see the "Require pairing for Bluetooth commands" setting on the Setup page.</td></tr>
