...
<?php
  ...
  if (isset($_POST["jmpto"])) {
   $exec= "echo " . escapeshellarg("91" . $_POST['jmpto'] . "#") . " > /tmp/dtmf_svx";
   exec($exec,$output);
   echo "<meta http-equiv='refresh' content='0'>";
    }
 if (isset($_POST["jmptoA"])) {
   $exec= "echo " . escapeshellarg("91" . $_POST['jmptoA'] . "#") . " > /tmp/dtmf_svx";
   exec($exec,$output);
   echo "<meta http-equiv='refresh' content='0'>";
    }
if (isset($_POST["jmptoM"])) {
   $exec= "echo " . escapeshellarg("94" . $_POST['jmptoM'] . "#") . " > /tmp/dtmf_svx";
   exec($exec,$output);
   echo "<meta http-equiv='refresh' content='0'>";
    }
