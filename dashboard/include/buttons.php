...
<?php
// sendTgSelectDtmf() (double-send workaround for RF.Guru's DTMF relay
// dropping the first character(s) on a cold connection) now lives in its
// own include -- see tg_select.php's header comment for the full story.
// Shared with dashboard-v2's Monitored Talkgroups module, which needs the
// function without this file's own POST-handling/HTML output.
require_once __DIR__ . '/tg_select.php';
