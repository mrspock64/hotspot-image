...
<?php
    ...
    echo '</div>'."\n";
?>
<center><span title="Dashboard" style="font: 7pt arial, sans-serif;">SvxLink Dashboard  ON3URE, G4NAB, SP2ONG, SP0DZ, SA0LEK, Claude <?php $cdate=date("Y"); if ($cdate > "2021") {$cdate="2021-".date("Y");} echo $cdate; ?>
</div>
</fieldset>
<br>
</body>
